// Simple and Fast Portfolio JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const elementsToAnimate = document.querySelectorAll('.section, .card, .skill-item, .project-card');
...
window.addEventListener('scroll', function() {
    ...
    // Add/remove scroll class to navbar for styling
